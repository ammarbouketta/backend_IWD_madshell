...
const Fonction = require('../Models/fonction').Fonction_db;
const ecrire = require('../Models/fonction').ecrire;
...
exports.recommand = (req, res,next) => {
        ...
        let question, questions = req.body.questions;
        for (question of questions) {
            switch (question.text) {
                ...
                case "What kind of job you want?":
                    switch (question.option=req.body.option) {
        ...
        res.status(201).json({ message: Object.keys(jobs).reduce((a, b) => jobs[a] > jobs[b] ? a : b)});
